  ...
  async approve(_spender: string, _tokens: number, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.approve(_spender, _tokens)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.approve(_spender, _tokens)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.approve(_spender, _tokens)
  ...
  async transferFrom(_from: string, _to: string, _tokens: number, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.transferFrom(_from, _to, _tokens)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.transferFrom(_from, _to, _tokens)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.transferFrom(_from, _to, _tokens)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }
  ...
  async transfer(_to: string, _tokens: number, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.transfer(_to, _tokens)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.transfer(_to, _tokens)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.transfer(_to, _tokens)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }

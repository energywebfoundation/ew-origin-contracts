  ...
  constructor(web3: Web3, address?: string) {
        super(address ? new web3.eth.Contract(EnergyCertificateBundleLogicJSON.abi, address) : new web3.eth.Contract(EnergyCertificateBundleLogicJSON.abi, EnergyCertificateBundleLogicJSON.networks.length > 0 ? (EnergyCertificateBundleLogicJSON.networks[0]) : null));
        this.web3 = web3;
    }
  ...
  async addEscrowForAsset(_bundleId: number, _escrow: string, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.addEscrowForAsset(_bundleId, _escrow)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.addEscrowForAsset(_bundleId, _escrow)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.addEscrowForAsset(_bundleId, _escrow)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }
...
if (_data) {
{
  ...
  async retireBundle(_bundleId: number, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.retireBundle(_bundleId)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.retireBundle(_bundleId)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.retireBundle(_bundleId)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }
  ...
  async removeEscrow(_bundleId: number, _escrow: string, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.removeEscrow(_bundleId, _escrow)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.removeEscrow(_bundleId, _escrow)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.removeEscrow(_bundleId, _escrow)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }

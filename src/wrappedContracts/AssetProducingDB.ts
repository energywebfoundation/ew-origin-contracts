    ...
    export class AssetProducingDB extends GeneralFunctions
{
	...
	async setIsBundled(_assetId:number,_bundled:boolean, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setIsBundled(_assetId,_bundled)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setIsBundled(_assetId,_bundled)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setIsBundled(_assetId,_bundled)
	...
	async setAssetOwner(_assetId:number,_owner:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setAssetOwner(_assetId,_owner)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setAssetOwner(_assetId,_owner)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setAssetOwner(_assetId,_owner)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setLastSmartMeterReadWh(_assetId:number,_lastSmartMeterReadWh:number, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setLastSmartMeterReadWh(_assetId,_lastSmartMeterReadWh)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setLastSmartMeterReadWh(_assetId,_lastSmartMeterReadWh)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setLastSmartMeterReadWh(_assetId,_lastSmartMeterReadWh)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async addMatcher(_assetId:number,_matcher:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.addMatcher(_assetId,_matcher)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.addMatcher(_assetId,_matcher)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.addMatcher(_assetId,_matcher)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setMatcherExternal(_assetId:number,_matcher:string[], txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setMatcherExternal(_assetId,_matcher)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setMatcherExternal(_assetId,_matcher)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setMatcherExternal(_assetId,_matcher)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async removeMatcherExternal(_assetId:number,_removal:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.removeMatcherExternal(_assetId,_removal)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.removeMatcherExternal(_assetId,_removal)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.removeMatcherExternal(_assetId,_removal)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setMatcher(_assetId:number,_matcher:string[], txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setMatcher(_assetId,_matcher)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setMatcher(_assetId,_matcher)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setMatcher(_assetId,_matcher)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setLastSmartMeterReadFileHash(_assetId:number,_lastSmartMeterReadFileHash:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setLastSmartMeterReadFileHash(_assetId,_lastSmartMeterReadFileHash)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setLastSmartMeterReadFileHash(_assetId,_lastSmartMeterReadFileHash)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setLastSmartMeterReadFileHash(_assetId,_lastSmartMeterReadFileHash)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setMarketLookupContract(_assetId:number,_marketLookupContract:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setMarketLookupContract(_assetId,_marketLookupContract)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setMarketLookupContract(_assetId,_marketLookupContract)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setMarketLookupContract(_assetId,_marketLookupContract)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	async setSmartMeterRead(_assetId:number,_lastSmartMeterReadWh:number,_lastSmartMeterReadFileHash:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setSmartMeterRead(_assetId,_lastSmartMeterReadWh,_lastSmartMeterReadFileHash)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setSmartMeterRead(_assetId,_lastSmartMeterReadWh,_lastSmartMeterReadFileHash)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setSmartMeterRead(_assetId,_lastSmartMeterReadWh,_lastSmartMeterReadFileHash)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	...
	async removeMatcher(_assetId:number,_removal:string, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.removeMatcher(_assetId,_removal)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.removeMatcher(_assetId,_removal)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.removeMatcher(_assetId,_removal)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	...
	async addFullAsset(_a:any, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.addFullAsset(_a)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.addFullAsset(_a)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.addFullAsset(_a)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	...
	async setActive(_assetId:number,_active:boolean, txParams?:SpecialTx){
            ...
            const txData = await this.web3Contract.methods.setActive(_assetId,_active)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setActive(_assetId,_active)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setActive(_assetId,_active)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}

  ...
  async addEscrowForAsset(_entityId: number, _escrow: string, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.addEscrowForAsset(_entityId, _escrow)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }
  ...
  async setEscrow(_entityId: number, _escrow: string[], txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.setEscrow(_entityId, _escrow)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.setEscrow(_entityId, _escrow)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setEscrow(_entityId, _escrow)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }
  ...
  async createTradableEntityEntry(_assetId: number, _owner: string, _powerInW: number, _acceptedToken: string, _onChainDirectPurchasePrice: number, txParams?: SpecialTx) {
            ...
            const txData = await this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _acceptedToken, _onChainDirectPurchasePrice)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _acceptedToken, _onChainDirectPurchasePrice)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} );
                    } catch (ex) {
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.createTradableEntityEntry(_assetId, _owner, _powerInW, _acceptedToken, _onChainDirectPurchasePrice)
                    .send({from: transactionParams.from, gas: transactionParams.gas});
            }
    }

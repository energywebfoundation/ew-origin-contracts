    ...
    import TestReceiverJSON from '../../contract-build/TestReceiver.json';
  ...
  constructor(web3: Web3, address?: string) {
    ...
    async onERC721Received(_operator: string, _from: string, _tokenId: number, _data: string, txParams?: SpecialTx) {

            let transactionParams;

            const txData = await this.web3Contract.methods.onERC721Received(_operator, _from, _tokenId, _data)
            .encodeABI();
            ...
            if (txParams) {
                ...
                if (!txParams.gas) {
                    ...
                    try {
                    gas = await this.web3Contract.methods.onERC721Received(_operator, _from, _tokenId, _data)
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.onERC721Received(_operator, _from, _tokenId, _data)
